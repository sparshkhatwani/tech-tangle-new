...
const ProblemDescription: React.FC<ProblemDescriptionProps> = ({ problem, _solved }) => {
  ...
  const handleLike = async () => {
    ...
    await runTransaction(firestore, async (transaction) => {
      ...
      if (userDoc.exists() && problemDoc.exists()) {
        if (liked) {
          // remove problem id from liked problems on user document, decrement likes on problem document
  ...
  return (
    <div className="bg-dark-layer-1">
      {/* TAB */}
      <div className="font-inter flex h-11 w-full items-center pt-2 bg-dark-layer-2 text-white overflow-x-hidden">
        <div
          className={
      ...
      <div className="font-inter flex px-0 py-4 h-[calc(100vh-94px)] overflow-y-auto">
        <div className="px-5">
          {/* Problem heading */}
